class SearchPage {
    ...
    static createUserBlock = function (userEntity) {
        ...
        openProfileButton.onclick = function () {
            SearchPage.openProfile(userEntity.id)
        };
        ...
        sendMessageButton.onclick = function () {
            SearchPage.openBlockForMessageSending(userEntity.id);
        };
    ...
    static openProfile = function (id) {
        window.location.href = "page_of_user.html?" + id;
    };

    static openBlockForMessageSending(receiverId){
